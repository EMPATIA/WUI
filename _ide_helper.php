 ...
 * Generated for Laravel 5.2.6 on 2016-02-16.
 *
...
namespace {
    ...
    class ONE extends \App\One\OneFacade{
         ...
         * @static 
         */
        public static function verifyKeysRequest($keys, $request){
            return \App\One\One::verifyKeysRequest($keys, $request);
        }
         ...
         * @static 
         */
        public static function verifyToken($request, $modid = null){
            return \App\One\One::verifyToken($request, $modid);
        }
        ...
        public static function actionType($name = 'form'){
            return \App\One\One::actionType($name);
        }
        ...
        public static function initOptions($name, $options){
            return \App\One\One::initOptions($name, $options);
        }
         ...
         * @static 
         */
        public static function form($name = 'form', $title = null, $type = null, $layout = '_layouts.form-empatia'){
            return \App\One\One::form($name, $title, $type, $layout);
        }
        ...
        public static function actionButtons($id, $params){
            return \App\One\One::actionButtons($id, $params);
        }
        ...
        public static function get($requestData){
            return \App\One\One::get($requestData);
        }
        ...
        public static function put($requestData){
            return \App\One\One::put($requestData);
        }
        ...
        public static function post($requestData){
            return \App\One\One::post($requestData);
        }
        ...
        public static function delete($requestData){
            return \App\One\One::delete($requestData);
        }
        ...
        public static function send($action, $requestData){
            return \App\One\One::send($action, $requestData);
        }
        ...
        public static function sendLog($type, $message){
            return \App\One\One::sendLog($type, $message);
        }
         ...
         * @static 
         */
        public static function buildNestedMenu($menu, $parent = 0){
            return \App\One\One::buildNestedMenu($menu, $parent);
        }
         ...
         * @static 
         */
        public static function buildPublicMenu($menuArray, $level = 0){
            return \App\One\One::buildPublicMenu($menuArray, $level);
        }
        
    }


    class OneLog extends \App\One\OneLog{
