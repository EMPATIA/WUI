...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            @else
                <table id="cb_list" class="table table-bordered table-hover table-striped">
                    <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            <button type="button" class="btn btn-flat btn-success btn-xs" data-toggle="modal" data-target="#createCbsCreateModal">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div class="row">
                            @if(ONE::verifyModuleAccess('cb','idea'))
                                <div class="col-md-6 col-xs-12" style="padding-top: 10px">
                                    <a class="btn btn-flat btn-block btn-success" href="{{action('CbsController@create','idea')}}">
                            ...
                            @if(ONE::verifyModuleAccess('cb','forum'))
                                <div class="col-md-6 col-xs-12" style="padding-top: 10px">
                                    <a class="btn btn-flat btn-block btn-success" href="{{action('CbsController@create','forum')}}">
                            ...
                            @if(ONE::verifyModuleAccess('cb','discussion'))
                                <div class="col-md-6 col-xs-12" style="padding-top: 10px">
                                    <a class="btn btn-flat btn-block btn-success" href="{{action('CbsController@create','discussion')}}">
                            ...
                            @if(ONE::verifyModuleAccess('cb','proposal'))
                                <div class="col-md-6 col-xs-12" style="padding-top: 10px">
                                    <a class="btn btn-flat btn-block btn-success" href="{{action('CbsController@create','proposal')}}">
                            ...
                            @if(ONE::verifyModuleAccess('cb','public_consultation'))
                                <div class="col-md-6 col-xs-12" style="padding-top: 10px">
                                    <a class="btn btn-flat btn-block btn-success" href="{{action('CbsController@create','publicConsultation')}}">
                            ...
                            @if(ONE::verifyModuleAccess('cb','tematic_consultation'))
                                <div class="col-md-6 col-xs-12" style="padding-top: 10px">
                                    <a class="btn btn-flat btn-block btn-success" href="{{action('CbsController@create','tematicConsultation')}}">
                            ...
                            @if(ONE::verifyModuleAccess('cb','survey'))
                                <div class="col-md-6 col-xs-12" style="padding-top: 10px">
                                    <a class="btn btn-flat btn-block btn-success" href="{{action('CbsController@create','survey')}}">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">{{trans("privateCbs.close")}}</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="panel panel-default flat">
                        ...
                        <div class="panel-heading">{{trans('privateCbs.add_comments')}}</div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" id="closeUpdateStatus">{{trans("privateCbs.close")}}</button>
