...
@section('scripts')
    ...
    <script>
        ...
        {!! ONE::imageUploader('slideUploader', action('FilesController@upload'), 'contentFileUploaded', 'select-slide', 'slide-drop-zone', 'slide-list', 'files_slide', 'getCroppedCanvasModal', 5/8, 3, isset($uploadKey) ? $uploadKey : "") !!}
        slideUploader.init();
