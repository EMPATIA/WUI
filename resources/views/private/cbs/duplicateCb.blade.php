    ...
    <div class="container-fluid">
        <div class="box box-primary">
            <div class="box-header">
                <h2 class="box-title box-title-idea-msg">{!! trans("privateCbs.duplicate_cb") !!}</h2>
            </div>
                                        ...
                                        @foreach($configuration->configurations as $configurationValue)
                                            <tr>
                                                <td>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="configuration_{{$configurationValue->id}}"  @if($oldCbConfigurations->has($configurationValue->code)) checked @endif> {{$configurationValue->title}}
                                                        </label>
                                                    </div>
                                                </td>
                                            </tr>
