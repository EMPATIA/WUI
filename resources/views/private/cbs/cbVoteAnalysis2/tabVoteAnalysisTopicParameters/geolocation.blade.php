...
@if(!empty($parameterId) && !empty($geoLocations))
    <div class="padding-top-20 padding-bottom-20 margin-bottom-30">
        <div class="row">
            <div class="col-12">
                <div class="box-info">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-map"></i> {{ trans('privateCbsVoteAnalysis.geolocation') }}
                            @if($viewSubmitted == 0)
                    ...
                    <div class="box-body" style="padding-top:0;">
                        <div id="map{{$parameterId}}" style="height:500px;width:100%;"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function initMap{{$parameterId}}() {
            var map = new google.maps.Map(document.getElementById('map{{$parameterId}}'), {
                zoom: 8,
...
@if(!empty($parameterId) && !empty($geoLocations))
    <div class="padding-top-20 padding-bottom-20 margin-bottom-30">
        <div class="row">
            <div class="col-12">
                <div class="box-info">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-map"></i> {{ trans('privateCbsVoteAnalysis.heatmap') }}
                            @if($viewSubmitted == 0)
                                [ {{ trans('privateUserAnalysis.votes_all') }} ]
                            @else
                                [ {{ trans('privateUserAnalysis.votes_submitted') }} ]
                    ...
                    <div class="box-body" style="padding-top:0;">
                        <div id="heatMap{{$parameterId}}" style="height:500px;width:100%;"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        // standard map
        map = new google.maps.Map(document.getElementById("heatMap{{$parameterId}}"), myOptions);
        // heatmap layer
