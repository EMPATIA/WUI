        ...
        <div class="col-12 tabs-left" id="nav-analysis" hidden="hidden">
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="nav-item">
                    <a class="nav-link active" href="#tab_vote_analysis_total_detail2" role="tab" id="vote_analysis_total_detail2" data-toggle="tab" aria-expanded="true">
                        {{ trans('privateCbsVoteAnalysis.total') }}
                    </a>
                </li>
                <li role="presentation" class="nav-item">
                    <a class="nav-link" href="#tab_vote_analysis_by_channel_detail2" role="tab" id="vote_analysis_by_channel_detail2" data-toggle="tab" aria-expanded="true">
                        {{ trans('privateCbsVoteAnalysis.channel') }}
                    </a>
                </li>
                <li role="presentation" class="nav-item">
                    <a class="nav-link" href="#tab_vote_analysis_table_by_channel_detail2" role="tab" id="vote_analysis_table_by_channel_detail2" data-toggle="tab" aria-expanded="true">
                        {{ trans('privateCbsVoteAnalysis.table_view') }}
                    </a>
                </li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="tab_vote_analysis_total_detail2">
                ...
                <div role="tabpanel" class="tab-pane" id="tab_vote_analysis_by_channel_detail2"></div>
                <div role="tabpanel" class="tab-pane" id="tab_vote_analysis_table_by_channel_detail2"></div>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function () {
            $("#tab_vote_analysis_total_detail2").hide();
            $("#tab_vote_analysis_by_channel_detail2").hide();
