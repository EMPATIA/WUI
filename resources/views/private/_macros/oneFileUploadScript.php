    ...
    var fileUploader_<?php echo $objName; ?> = new plupload.Uploader(
        {
            ...
            chunk_size: '1mb',
            multi_selection: <?php echo ($multi_selection) ? "true" : "false"; ?>,
            filters: {  max_file_size: '<?php echo $max_file_size; ?>',
                prevent_duplicates: <?php echo (isset($prevent_duplicates) ? (($prevent_duplicates) ? "true" : "false") : 'false'); ?>,
            ...
            init: {
                ...
                FilesAdded: function (up, files) {
                    ...
                    if (oldFiles.length>=<?php echo $fileCountLimit;?>) {
                        ...
                        showFileUploadError_<?php echo $objName; ?>('<?php echo trans('files.file_limit_reached_removed_oldest'); ?>');
                    }
                    ...
                    if ($("#<?php echo $objName; ?>").val()=="null" || $("#<?php echo $objName; ?>").val()=="" || JSON.parse($("#<?php echo $objName; ?>").val()).length<<?php echo $fileCountLimit;?>) {
                        ...
                        showFileUploadError_<?php echo $objName; ?>('<?php trans('files.file_limit_reached'); ?>');
