    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{{ trans("privateCbs.add_parameter") }}</h4>
            </div>
            <div class="modal-body">
                <div id="modalAddParameterButtons" class="row modalAddParameterButtons">      
                    <div class="col-12">
                        <span>{{ trans("privateCbs.add_parameter_choose_option") }}</span>
                        <br/><br/>
                    </div>
                    <div class="col-12 col-md-6">
                        <a href="javascript:addNewParameterItem2({{ $parameterCounter }})" class="btn btn-flat btn-success btn-sm" title="Create parameter"  data-original-title="Create parameter">
                            <i class="fa fa-plus"></i> {{ trans("privateCbs.add_parameter") }}
                        </a>               
                        <span class="form-text oneform-help-block" style="margin:6px 0px 0px;font-size:10px;">{{ trans("privateCbs.help_add_parameter") }}</span>
                    </div>
                    <div class="col-12 col-md-6">
                        <a href="javascript:addNewParameterTemplate2({{ $parameterCounter }})" class="btn btn-flat btn-warning btn-sm" title="Create template"  data-original-title="Create template" style="margin-right:20px;">
                            <i class="fa fa-plus"></i> {{ trans("privateCbs.add_parameter_template") }}
                        </a>
                        <span class="form-text oneform-help-block" style="margin:6px 0px 0px;font-size:10px;">{{ trans("privateCbs.help_add_parameter_template") }}</span>
                    </div>                        
                </div>    
