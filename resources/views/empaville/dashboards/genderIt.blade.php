    ...
    <script>
        ...
        $(function () {
            ...
            var PieData = [
                ...
                {
                    value: [{!! isset($votesByGender->Transgender->Total) ? $votesByGender->Transgender->Total : null !!}],
                    color: "#ff3399",
                    highlight: "#ff3399",
                    label: "Transgender"
                }
                ...
                datasets: [
                    {
                        ...
                        data:[
                            ...
                            {!! isset($votesByGender->Transgender->Positives) ? $votesByGender->Transgender->Positives : null !!}
                        ]
                    },
                    {
                        label: "Negatives",
                        ...
                        data: [
                            ...
                            {!! isset($votesByGender->Transgender->Negatives) ? $votesByGender->Transgender->Negatives : null !!}
                        ]
                    }
                ]
            };
                ...
                datasets: [
                    {
                        ...
                        data:[
                            ...
                            {!! isset($firstByGender->Transgender->Positives) ? $firstByGender->Transgender->Positives : null !!}
                        ]
                    },
                    {
                        label: "Negatives",
                        ...
                        data: [
                            ...
                            {!! isset($firstByGender->Transgender->Negatives) ? $firstByGender->Transgender->Negatives : null !!}
                ...
                datasets: [
                    {
                        ...
                        data:[
                            ...
                            {!! isset($secondByGender->Transgender->Positives) ? $secondByGender->Transgender->Positives : null !!}
                        ]
                    },
                    {
                        label: "Negatives",
                        ...
                        data: [
                            ...
                            {!! isset($secondByGender->Transgender->Negatives) ? $secondByGender->Transgender->Negatives : null !!}
                        ]
                    }
                ]
            };
