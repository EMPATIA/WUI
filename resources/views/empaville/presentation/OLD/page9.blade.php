...
@section('content')
    ...
    <div class="content" style="padding-top: 0%">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h2>
                    <ul style="color: #66A2D8">
                        ...
                        <li style='padding-top: 1em'><span style="color: black">Maximum 1 negative vote</span></li>
                    </ul>
                </h2>
            </div>
        ...
        <div style="float: right">
            <a class="right carousel-control" style="width: 5%" id="rightBtn" onclick="location.href='{{ action('EmpavillePresentationController@showProposal',['cbId'=> $cbId, 'id'=>($id+1),'count'=>1]) }}'" role="button">
