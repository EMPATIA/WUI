...
@section('content')
    ...
    <div class="content">
        <div class="container" style="height: 100%;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="col-lg-9 col-md-8 col-sm-8" id="box1">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h2>You will have 20mn to read the final proposals and decide which ones you want to vote</h2>
                        <h2>You will vote, according to the assigned channel</h2>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3" id="box3">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center" style="padding-top: 2%" id="divMoreTime" hidden>
                        <button class="btn btn-success" id="btnMoreTime">+1Minute</button>
                    </div>
                </div>
        ...
        <div style="float: left">
            <a class="left carousel-control" style="width: 5%" id="leftBtn" onclick="location.href='{{ action('EmpavillePresentationController@showProposal',['cbId'=> $cbId, 'id'=>($id-1),'count'=> '4']) }}'" role="button">
    ...
    <script>
        function openVotes(){
            $.ajax({
                ...
                data: { _token: "{{ csrf_token() }}", cbId:"{{$cbId}}"}, // a JSON object to send back
