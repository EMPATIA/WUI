    ...
    <div class="content">
        <div class="container" style="height: 100%;padding-top: 5%;">
            <div class="col-lg-9 col-md-9 col-sm-9" id="box1" style="box-shadow: 0px 0px 23px -3px rgba(0,0,0,0.75);">
                <h2>Você irá participar na mesa redonda do seu bairro, guiados pelo moderador</h2>
                <h2>Tem 20mn para apresentar uma proposta para o seu bairro</h2>
                <h2>Cada mesa decide e selecciona 2 propostas, segundo a modalidade definida para a mesa</h2>
