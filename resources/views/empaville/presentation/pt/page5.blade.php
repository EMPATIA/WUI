    ...
    <div class="content" id="divCont">
        <div class="container" style="height: 100%;padding-top: 5%;padding-bottom: 5%">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6" style="padding-top: 10%;">
                <h1 style="color: #66A2D8;font-size: 4em"><b>"Dados"</b></h1>

                <a href="{{action('CbsController@voteAnalysis', ['type' => 'idea', 'cbKey'=> $cbKey])}}" target="_blank"><span class="fa fa-hand-o-right" style="font-size: 2em">Vencedores e Análise de Dados</span> </a>
            </div>
        </div>
