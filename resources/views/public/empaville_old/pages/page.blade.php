    ...
    <div id="header-title-bar">
        <div class="container-fluid" id="content-container">
            <div class="row">
                <div class="col-md-12">
                    <div id="header-title">
                        {!! $pageContent->title or trans('PublicContent.pageTitle')!!}
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div id="side-col" class="col-md-3">
                                ...
                                <div style="background-color: #f4f4f4; padding: 10px;">
                                            ...
                                            @if (!empty($slideshow) && !empty($slideshow[1]))
                                                <a class="left carousel-control" href="#side-carousel"
                                                   ...
                                                   data-slide="prev">
                                                    ...
                                                    <span class="sr-only">{{trans("PublicContent.previous")}}</span>
                                                </a>
                                                <a class="right carousel-control" href="#side-carousel"
                                                   ...
                                                   data-slide="next">
                                                                    <span class="glyphicon glyphicon-chevron-right"
                                                                          aria-hidden="true"></span>
                                                    <span class="sr-only">{{trans("PublicContent.next")}}</span>
                                                </a>
                                            @endif
                                        </div>
                                    ...
                                    @if (isset($contentType['news']) && count(count($contentType['news'])) > 0 && !empty($news))
                                        <div class="row">
                                            <div id="column-title" class="col-md-4">
                                                <i class="fa fa-newspaper-o"></i> {{ trans('public.news') }}
                                    ...
                                    @if (isset($contentType['events']) && count(count($contentType['events'])) > 0 && !empty($events))
                                        <div class="row">
                                            <div id="column-title" class="col-md-4">
                                                <i class="fa fa-calendar"></i> {{ trans('public.events') }}
