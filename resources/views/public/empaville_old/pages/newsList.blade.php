                    ...
                    <div style="background-color: white;" class="box">
                        <div class="box-header">
                            <h4 class="attachment-heading">
                                <a href="{{ URL::action('ContentsController@showNews', $item->content_key) }}">{!! $item->title !!}</a>
                            </h4>
                            <span class="time">
                        ...
                        <div class="attachment-block clearfix">
                            ...
                            <a href="{{ URL::action('ContentsController@showNews', $item->content_key) }}">{{trans('PublicContent.continueReading')}}...</a>
                        </div>
                    </div>                
                @endforeach
                <br>
