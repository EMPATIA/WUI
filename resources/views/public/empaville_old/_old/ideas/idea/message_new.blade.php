    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-widget">
                <div class="box-body">
                    <div class="row">
                        <div class=" {{ (($posX != "" && $posY != "") || count($files) > 0)? "col-md-8 col-sm-8" : "col-sm-12 col-xs-12"}}  ">
                            <div class="title" style="color:#62a351; font-weight: 600; font-size: 24px;">
                                {{$topic->title}}
                            </div>
                            <div style="font-size: 11px">
                                <i class="fa fa-user" style="color: #8cc542"></i> {{$usersNames[$topic->created_by]['name']}} &nbsp;&nbsp;<i class="fa fa-calendar" style="color: #8cc542"></i> {{$topic->created_at}} &nbsp;&nbsp;<i class="fa fa-comments-o" style="color: #8cc542"></i> {{count($messages)}} Comments
                            </div>
                    ...
                    <div class="row">
                        @if(count($parameters) > 0)
                            <div class="options col-md-8" style="margin-top: 20px; font-size: 11px;  width: 30%">
                        ...
                        @endif
                        @if(count($files) > 0)
                            <div class="gallery col-md-4" style="margin-top: 15px; font-size: 11px">
                                <b>gallery</b>
                                <div style="border-top: 1px solid #62a351; padding-top: 5px">
                    ...
                    <div class="row">
                        ...
                        @if($existVotes == 1)
                            <div class="vote col-md-4 pull-right" style="font-size: 11px;z-index:999999;" data-toggle="tooltip" data-placement="top" data-original-title="Remaining total votes: {{$total}}. You can use {{$negative}} negative votes.">
                                <b >vote</b>
                        ...
                        <div class="col-md-8" style="padding-top: 10px;">
                            <a href="{!! action('PublicIdeasController@index', $cbId) !!}" class="btn btn-flat empatia" >{{ trans('proposal.back') }}</a>
                        </div>
