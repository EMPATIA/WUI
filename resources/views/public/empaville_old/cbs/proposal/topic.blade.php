                ...
                <div class="row proposal">
                    ...
                    <div class="col-sm-12 col-xs-12 col-md-12" style="margin-top: 25px;padding-left: 20px; padding-right: 20px">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6" style="margin-top:10px">
                            ...
                            <div class="buttons">
                                <a href="{{action('PublicTopicController@index', ['cbKey' => $cbKey, 'type' => $type])}}" class="btn btn-flat empatia" style="padding: 3px 12px;">{{ trans('PublicCbs.back') }}</a>
                                @if($prevIdea != null)
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="pull-right" style="padding: 0px 10px 10px 0px;">
                            @if(ONE::isAuth() && Session::has('user') && Session::get('user')->user_key == $topic->created_by || $isModerator)
                                <a href="{!!  action('PublicTopicController@edit', ['cbKey' => $cbKey, 'topicKey' => $topic->topic_key, 'type' => $type]) !!}" style="cursor: pointer; font-weight: bold; color:#62a351; font-size: 10px;">Edit Proposal</a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="box box-widget" style="margin-bottom: 0px;border-bottom: 2px solid #f4f4f4;"
                    ...
                    @if(ONE::isAuth() && ONE::checkCBsOption($configurations, 'ALLOW-COMMENTS'))
                        <div class="box-footer" style="margin-top: 20px" id="new_post">
                            <form name="new_post_form" accept-charset="UTF-8" method="POST"
                                ...
                                <div class="img-push">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button type="submit" form="new_post_form" class="btn empatia btn-flat">{{ trans("PublicCbs.send") }}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
