                    ...
                    @if($isModerator == 1)
                        <div style="float:right">
                            <a href="{!! action('PublicTopicController@create', ['cbKey' => $cbKey, 'type' => $type]) !!}"
                               class="btn btn-flat empatia">{{ trans('PublicCbs.create') }}</a>
                        </div>
                    @endif
                </div>
                        ...
                        {{--<div style="padding-bottom: 20px;margin-left: 15px;">--}}
                             ...
                             {{--@endif--}}
                                 ...
                                 {{--<div class="btn-group" role="group">--}}
                                     {{--<div class="dropdown">--}}
                                         {{--<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">--}}
                                             {{--<span id="dropdown-location">{{trans('empaville.location')}}</span>--}}
                                             {{--<span class="caret"></span></button>--}}
                                         {{--<ul class="dropdown-menu">--}}
                                             {{--<li><a href="javascript:showOptions('0', 'Location', 'Location')">{{trans('empaville.removeFilter')}}</a></li>--}}
                                             {{--<li role="separator" class="divider"></li>--}}
                                             {{--<li><a href="javascript:showOptions('1', 'UpTown', 'Location')">{{trans('empaville.upTown')}}</a></li>--}}
                                             {{--<li><a href="javascript:showOptions('2', 'MiddleTown', 'Location')">{{trans('empaville.middleTown')}}</a></li>--}}
                                             {{--<li><a href="javascript:showOptions('3', 'DownTown', 'Location')">{{trans('empaville.downtown')}}</a></li>--}}
                                         {{--</ul>--}}
                                     {{--</div>--}}
                                 {{--</div>--}}
...
@section('scripts')
    ...
    <!-- Dot Dot Dot -->
    <script>
        $.each([$(".idea-desc")], function( index, value ) {
