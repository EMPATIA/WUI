                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            ...
                            <div class="row white-bg form-row">
                                <div clasS="col-lg-4 form-label">
                                    {!! Form::label('contents', ONE::transCb('cb_description_help', !empty($cb) ? $cb->cb_key : $cbKey) . (ONE::isEdit() ? "*" : ""), array('class' => 'label-required color-secundary')) !!}
                                </div>
                                <div clasS="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <small id="locationHelp" class="form-text text-muted">{!! ONE::transCb('cb_google_maps', !empty($cb) ? $cb->cb_key : $cbKey)  !!}</small>
                                    </div>
                                </div>
                            </div>
                            @if((count($parameters) > 0))
