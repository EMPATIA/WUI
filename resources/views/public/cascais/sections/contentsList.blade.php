    ...
    $(document).ready(function () {
        $.ajax({
            ...
            data: {
                ...
                $("#contents").append('<div class="col-md-12 col-xs-12 loader"><div class="text-center"><img src="{{ asset('images/bipart/bluePreLoader.gif') }}" alt="Loading"  style="width: 40px;"/></div></div>');
                $(".loader").show();
