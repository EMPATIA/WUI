    ...
    <section>
        <div class="container-fluid aboutBanner">
            <div class="row menus-row">
                <div class="menus-line col-sm-6 col-sm-offset-3"><i class="fa fa-check-square-o" style="color: #b3b3b3"></i>{{ trans('PublicQuestionnaire.questionnaire') }}</div>
            </div>
        </div>
            ...
            var move = function() {
                ...
                if(st > ot) {
                    ...
                    s.css({
                        ...
                        top: "0px",
                        'margin-top':"0px",
                        '-moz-box-shadow':' 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.25)',
                        '-webkit-box-shadow': '0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.25)',
