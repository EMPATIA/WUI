...
<div class="container" style="padding-bottom: 50px;margin-top: 40px">

    <div class="row menus-row">
        <div class="menus-line col-sm-6 col-sm-offset-3 mainTitleCb">
            <i class="fa fa-commenting"></i>{{$cb->title}}
        </div>
    ...
    <div style="background-color: white;padding:10px 20px 10px 20px; margin-top: 40px; margin-bottom: 50px">
        <div class="row">
            <div class="col-xs-12"><div class="topicIdeaSubtitle">{{$topic->title}}</div></div>
        </div>


        {{--<!----}}
        {{--<div class="contentPage-heading-wrapper">--}}
            {{--<div class="contentPage-heading">--}}
                {{--<div class="contentPage-heading-txtContainer">--}}
                    {{--<h2>{{$topic->title}}</h2>--}}
                {{--</div>--}}
            {{--</div>--}}
            {{--<div class="contentPage-heading-icon">--}}
                {{--<span>{{ trans("PublicCbs.ideas") }}</span>--}}
            {{--</div>--}}
        {{--</div>--}}
        {{---->--}}
