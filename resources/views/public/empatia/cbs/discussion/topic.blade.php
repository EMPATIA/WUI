...
@section('content')
    ...
    <div class="container" style="margin-top: 40px">
        ...
        <div style="background-color: white;padding:10px 20px 10px 20px; margin-top: 40px; margin-bottom: 50px">
            <div class="row">
                <div class="col-xs-12 topicDiscussionSubtitle">{{$topic->title}}</div>
            </div>
                                        ...
                                        <div class="row">
                                            @foreach($parameters as $parameter)
                                                <div class="col-xs-12 col-sm-12 col-md-12 topicsItemParameters">
                                                    ...
                                                    @else
                                                        <div class="parameteTxt">{{ $parameter->parameter }}</div>
                                                    @endif
                                                    ...
                                                    @else
                                                        <b class="parameterLabel">{{$parameter->pivot->value}}</b>
                                                    @endif
                                                </div>
                                            @endforeach
                                        </div>
