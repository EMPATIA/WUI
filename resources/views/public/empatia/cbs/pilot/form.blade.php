...
@section('content')
    @include('public.empatia.home.smallBanner')
    <div class="row">
        <div class="container">
        <div class="col-md-12">
            <div class="my-box box-solid ">

                <div class="row menus-row">
                    <div class="menus-line col-sm-6 col-sm-offset-3"><i class="fa fa-tasks"></i>
                    @if (strpos(array_get(Route::getCurrentRoute()->getAction(), 'as', ''), 'create') !== false)                        
                        {!! trans('empatiaPilot.createTopic') !!}
                    @elseif(strpos(array_get(Route::getCurrentRoute()->getAction(), 'as', ''), 'edit') !== false)
                        {!! trans('empatiaPilot.editTopic') !!}
                    @endif                    
                    </div>          
                </div>                  
                ...
                <div style="padding:20px;font-family: 'Roboto', Sans-Serif; font-size: 1.2em">
                    ...
                    <!-- Form details -->
                    {!! Form::oneText('title', trans('empatiaPilot.cityName'), isset($topic) ? $topic->title : null, ['class' => 'form-control', 'id' => 'title', 'required']) !!}
                    {!! Form::oneTextArea('summary', trans('empatiaPilot.summary'), isset($topic) ? $topic->contents : null, ['class' => 'form-control', 'id' => 'summary', 'size' => '30x6', 'style' => 'resize: vertical','required']) !!}
                    {!! Form::oneTextArea('contents', trans('empatiaPilot.description'), isset($post) ? $post->contents : null, ['class' => 'form-control', 'id' => 'contents', 'size' => '30x14', 'style' => 'resize: vertical','required']) !!}
