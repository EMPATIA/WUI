...
@section('content')
    ...
    <div class="container" style="margin-top: 40px;">
        ...
        @if(!$closed && $isModerator)
            <div class="row">
                <div class="col-sm-12 col-xs-12 text-right">
                    <div class="ideaTopicParameter">
        ...
        <div style="background-color: white;padding:10px 20px 10px 20px; margin-top: 40px; margin-bottom: 50px; border-top: solid 2px #8ac340;">
            <div class="row">
                <div class="col-xs-12"><div class="topicForumSubtitle">{{$topic->title}}</div></div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 parameters discussionTopicParameter">
                                    <div>
                                        <div class="row">
                                            @foreach($parameters as $parameter)
                                                @if($parameter->type->code != 'google_maps' && $parameter->visible)
                                                    <div class="col-xs-12 parameters-topic">
                                ...
                                @if(isset($permissions) && array_key_exists("ALLOW-SHARE", $permissions) && $permissions["ALLOW-SHARE"])
                                    <div class="col-md-12 col-sm-6 col-xs-12 discussionTopicParameter">
                            ...
                            <div class="row" style="margin-top: 20px; border-top: solid 1px #e9e4e4">
