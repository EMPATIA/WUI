...
@section('content')
                        ...
                        <div class="col-12 ideas-filters">
                            <div class="row filters-row">
                                <div class="col-lg-8 col-md-7 col-sm-12 col-12">
                                    ...
                                    @if(!empty($cbFilter))
                                        <div class="topicFilter pt-2">
                                            <div class="filters-labels" style="padding-left:0">
                                                <label>
                                                    <span href="#" class="default-button-topics-label">
                                                        <span class="light-blue">{{ONE::transCb('status_filter', !empty($cb) ? $cb->cb_key : $cbKey)}}</span>
                                                    </span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="topicStatus">
                                            ...
                                            @endphp
                                           {{--@if(ONE::checkOperationSchedulePermission($operationSchedules,"ta_results","show"))--}}
                                                {{--{{dd(2)}}--}}
                                            @if($showStatusTypesFilters == true )
                                                    {{--{{dd(3)}}--}}
                                                    <label>
                                                        <span href="#" class="default-button-topics-label">
                                                            <span class="light-blue">{{trans('cbsProposal.status')}}</span>
                                                        </span>
                                                        @foreach($cbFilter as $key => $filter)
                                                            @if (!empty($key))

                                                                    <a href="#" class="default-button-topics background-light-blue dark-blue  my-filter-selector @if($cbFilter == $key) active @endif"
                                                                       data-option-id="{{ $key }}">
                                                                        <span class="dark-blue">{{ $key }}</span>
                                                                    </a>
                                                                @endif
                                                        @endforeach
                                                    </label>
                                ...
                                <div class="col-12 order-1 col-sm-12 col-md-5 offset-lg-1 col-lg-3 search-box">
    ...
    <div class="banner-voting-info">
        @if(!empty($voteType))
            ...
            @else
                @if(Session::has('user') && Session::get('user')->confirmed == 0 && ONE::getEntityKey() != 'z9cfQ5pRmTxX5SUWixYW0JlQN3pK9u4f')
