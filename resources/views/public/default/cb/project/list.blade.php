        ...
        @foreach($voteType as $vt)
            @if($vt['alreadySubmitted'] != true)
                <!-- Banner for votes allowed and enough to submit -->
                    <div id="voteBanner" class="row banner-voting-info votes-to-submit">
                        <div class="col-12">
            ...
            @else
                <!-- Banner for votes allowed and enough to submit -->
                    <div id="voteBanner" class="row banner-voting-info submited-votes">
                        <div class="col-12">
            ...
            <div id="voteBanner" class="row banner-voting-info votes-forbidden">
                <div class="col-12 banner-voting-col">
                    <a href="#" data-toggle="modal" data-target="#loginModal" onclick="login();">
                        Por favor faça Login para participar </a>
                </div>
            </div>
        @endif
                    ...
                    <div class="row">
                        <div class="col-12 ideas-filters">
                            <div class="row filters-row">
                                ...
                                <div class="col-12 order-1 col-sm-3 col-md-2 search-box mt-2">
                                <h1>AQUI</h1>
