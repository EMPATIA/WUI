                    ...
                    <div class="row">
                        <div class="col-md-4 col-xs-12">
                            <div class="parameter-user-comments">
                                <span class="glyphicon glyphicon-user"></span> {{ $usersNames->{$topic->created_by}->name ?? trans('defaultCbsProject2C.anonymous')}}
                            </div>
                            @if(ONE::checkCBsOption($configurations, 'ALLOW-COMMENTS'))
                                <div class="parameter-user-comments">
                                    <span class="glyphicon glyphicon-comment"></span> {{$topic->statistics->posts_counter ?? 0}} {{ trans('defaultCbsProject2C.comments')}}
                                </div>
                            @endif
                        </div>
                        <div class="col-md-4 col-xs-12">
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class='jscroll-next'
               href='{{ URL::action('PublicCbsController@show', ["cbKey"=> $cb->cb_key, "type"=> $type, 'listType' => 'listProject2Cs', 'page' => $topicsPagination->currentPage()+1])}}'>{{ trans("defaultCbsProject2C.next") }}</a>
        </div>
    </div>
@endif