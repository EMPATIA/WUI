                ...
                <div class="col-xs-12 cbs-box">
                    <div class="row">
                        <div class="col-xs-12 text-right" style="color:#585858">
                            ...
                            {{\Carbon\Carbon::now()->diffInDays(\Carbon\Carbon::parse($topic->created_at)).' '.trans('defaultCbsIdea.days')}}
                        </div>
                    </div>
                    <div class="row topic-contents">
                        ...
                        <div class="col-xs-12 idea-parameters">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6">
                                    <div class="topics-ideaDetail">
                                        <i class="fa fa-user" aria-hidden="true"></i> {{ $usersNames->{$topic->created_by}->name ?? trans('defaultCbsIdea.anonymous')}}
                                    </div>
                                    @if(ONE::checkCBsOption($configurations, 'ALLOW-COMMENTS') && $statistics->posts > 0)
                                        <div class="topics-ideaDetail">
                                            <i class="fa fa-comment-o" aria-hidden="true"></i> {{$statistics->posts}} {{trans('defaultCbsIdea.comments')}}
                                        </div>
                                    @endif
                                </div>
                                @if(!empty($voteType))
                            ...
                            <div class="col-xs-12">
                                <a href="{{ action('AuthController@login') }}">
                                    <div class="cb-topics-login-box text-center">
                                        ...
                                        {{ trans("defaultCbsIdea.login_to_vote") }}
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    {{--{{trans("defaultCbsIdea.view_more")}} <span class="glyphicon glyphicon-chevron-right"></span>--}}
                    {{--</div>--}}
                    {{--</a>--}}
                    {{--</div>--}}
                </div>
