    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="sub-title">
                    <h2 class="bolder">{{trans("defaultPadsProposal.create_proposal")}}</h2>
                </div>
            </div>
        </div>
                    ...
                    <!-- Files -->
                        @if(isset($configurations) && ((ONE::checkCBsOption($configurations, 'ALLOW-FILES')) || (ONE::checkCBsOption($configurations, 'ALLOW-PICTURES'))))
                            ...
                            <div class="form-group margin-top">
                                {!! ONE::fileSimpleUploadBox("drop-zone", trans("defaultPadsProposal.drag_and_drop_files_to_here") , trans('defaultPadsProposal.add_files'), 'select-files', 'files-list', 'files') !!}
                            </div>
