                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="pull-left" style="margin-top: 10px; margin-top: 10px; padding: 5px 10px 5px 10px; color: #333333">
                                ...
                                <span>{{ trans('defaultCbsProposal.reset_filters') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="pull-left">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" style="float: none">
                                                <li style="float: none"><a href={{action('PublicCbsController@show',['cbKey' => $cbKey, 'type' => $type, 'orderBy' => 'desc'])}}>{{trans('defaultCbsProposal.date')}} <i class="fa fa-arrow-up" aria-hidden="true"></i></a></li>
                                                <li style="float: none"><a href={{action('PublicCbsController@show',['cbKey' => $cbKey, 'type' => $type, 'orderBy' => 'asc'])}}>{{trans('defaultCbsProposal.date')}} <i class="fa fa-arrow-down" aria-hidden="true"></i></a></li>
                                                <li style="float: none"><a href={{action('PublicCbsController@show',['cbKey' => $cbKey, 'type' => $type, 'popularity' => 'desc'])}}>{{trans('defaultCbsProposal.popularity')}} <i class="fa fa-arrow-up" aria-hidden="true"></i></a></li>
                                                <li style="float: none"><a href={{action('PublicCbsController@show',['cbKey' => $cbKey, 'type' => $type, 'popularity' => 'asc'])}}>{{trans('defaultCbsProposal.popularity')}} <i class="fa fa-arrow-down" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row cbs-boxes topics-grid" id="infinite-scroll">
                    @if(isset($listType))
                        @if($listType == 'listProposals')
                            @include('public.default.cbs.proposal.topicsPadsInList')
                        @else
                            @include('public.default.cbs.proposal.topicsPads')
                        @endif
                    @endif
