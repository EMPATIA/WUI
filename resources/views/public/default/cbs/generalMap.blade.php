    ...
    <section>
        <div class="container">
            ...
            <div class="mapContainer">
                {!! Form::oneMapsLocations("mapsLocations", "", $locations, array("markerIcon" => asset('images/default/pins/construction.png'), "zoom" => 13, "folderIcons" => "/images/default/pins/", "defaultLocation" => "40.20103490981625, -8.411235809326172", "style" => "height:550px;width:100%;"), array("select" => "geometry", "from" => "1N2LBk4JHwWpOY4d9fobIn27lfnZ5MDy-NoqqRpk", "where" => "ISO_2DIGIT IN ('PT')")) !!}
            </div>
