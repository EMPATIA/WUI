        ...
        <div class="contentPage-heading-wrapper" style="z-index: 0">
            ...
            <div class="row pageSectionTitle">
                <div class="col-xs-12 col-sm-12">
                    <h1 class="page-title bolder">{{ trans("defaultUser.profile") }}</h1>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                ...
                <div class="top-buffer magin-bottom-15">
                    <div class="userProfileActions-button-div">
                        <button id="user-image" class="btn btn-flat btn-block center-block"><i
                        ...
                        <button class="btn btn-flat btn-block center-block top-buffer" data-toggle="modal" data-target="#changePasswordModal">
