            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="pads-title">
                        <h3>{!! trans('defaultCbsDiscussion.discussion') !!}</h3>
                    </div>
                </div>
            </div>

            <div class="row cbs-boxes" id="infinite-scroll">
                @include('public.empaville_new.cbs.discussion.padsList')
                @if(empty($cbsData) || count($cbsData) == 0)
                    <div class="col-xs-12">
                        <div class="alertBoxGreen">
                            <div class="col-xs-12 text-center">
                                <h2>{{ trans('defaultCbsDiscussion.no_discussion_to_display') }}</h2>
                            </div>
                            <div class="col-xs-12 text-center">
