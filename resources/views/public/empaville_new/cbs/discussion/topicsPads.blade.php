                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="alertBoxGreenNews">
                                            <i class="fa fa-exclamation-circle " aria-hidden="true"
                                                        style="margin-bottom: -10px; line-height: 50px;"></i> {{ trans("defaultCbsDiscussion.login_to_vote") }}
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    @if(ONE::checkCBsOption($configurations, 'ALLOW-COMMENTS'))
                                        ...
                                        <i class="fa fa-comments-o"
                                           aria-hidden="true"></i> {{$topic->statistics->posts_counter ?? 0}}
                                    @endif
                                    <span class="glyphicon glyphicon-option-vertical"></span>
                                    <i class="fa fa-user"
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class='jscroll-next'
               href='{{ URL::action('PublicCbsController@show', ["cbKey"=> $cb->cb_key, "type"=> $type, 'page' => $topicsPagination->currentPage()+1])}}'>{{ trans("defaultCbsDiscussion.next") }}</a>
        </div>
    </div>
@endif