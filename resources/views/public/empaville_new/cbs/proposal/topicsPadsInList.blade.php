            ...
            <div class="col-xs-10">
                <div class="row">
                    ...
                    @foreach($topic->parameters as $parameter)
                        ...
                        @endif
                    @endforeach
                    <div class="col-xs-12 topic-content-list">
                        <p>
                            @if($topic->contents == '')
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class='jscroll-next'
               href='{{ URL::action('PublicCbsController@show', ["cbKey"=> $cb->cb_key, "type"=> $type, 'listType' => 'listProposals', 'page' => $topicsPagination->currentPage()+1])}}'>{{ trans("defaultCbsProposal.next") }}</a>
        </div>
    </div>
@endif