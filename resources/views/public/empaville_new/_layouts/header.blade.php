<header>
    <nav class="navbar navbar-top-login">
        <div class="container">
            @include('public.empaville_new._layouts.languages')
                    ...
                    <!-- User Account Menu -->
                        <li class="dropdown">
                            ...
                            @if(Session::get('user')->photo_id > 0)
                                <a data-toggle="dropdown" class="dropdown-toggle loggedUserNavBar dropdownTrigger" href="#">
                            ...
                            @else
                                <a data-toggle="dropdown" class="dropdown-toggle dropdownTrigger" href="#">
    ...
    <nav class="navbar navbar-top-menus">
        ...
        <div class="container">
            <div class="col-xs-3 home-logo">
                <a href='{{url('/')}}'><img class="logo" id='logo' alt="Logo" src="{{asset('images/empaville/EmpavilleLogo.png')}}" height="45px" /></a>
            </div>
