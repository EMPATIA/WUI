    ...
    <div class="container news-container">
        <div class="row">
            <div class="col-md-9 col-xs-12">
                <h1 class="homeSectionTitle">{{trans('empavilleHome.last_news')}}</h1>
            </div>
            <div class="col-md-3 col-xs-12 news-button-div">
                <a href="{{ action('PublicContentsController@showContentsList', ['type' => 'news']) }}">{{trans("empavilleHome.view_all")}}</a>
            </div>
        </div>
        <div class="row">
            @if(isset($lastNews))
                        ...
                        <div class="alertBoxGreenNews">
                            <div class="col-xs-12 text-center">
                                <h2><i class="fa fa-exclamation-circle "
                                       aria-hidden="true"></i> {{ trans("empavilleHome.there_are_no_news") }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
