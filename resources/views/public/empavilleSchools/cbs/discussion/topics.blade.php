    ...
    <section>
        <div class="container pads-container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="pads-title">
                        <h3>{!! $cb->title ??  trans('defaultCbsDiscussion.discussion') !!}</h3>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="pads-description">
                        <h3>{!! $cb->contents ?? trans('defaultCbsDiscussion.discussion_description') !!}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row cbs-boxes" id="infinite-scroll">
                @include('public.default.cbs.discussion.topicsPads')
