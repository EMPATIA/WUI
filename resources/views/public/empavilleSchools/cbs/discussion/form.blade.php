...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="sub-title">
                    <h2 >{{trans("defaultPadsDiscussion.create_topic")}}</h2>
                </div>
            </div>
        </div>
        <div class="row form">
...
@section('scripts')
    ...
    <script>
        $('#topic').submit(function() {
            ...
            if(!isValid){
                toastr.error('{{ trans('defaultPadsDiscussion.fillInAllRequiredFieldsOnForm') }}', '', {timeOut: 3000,positionClass: "toast-bottom-right"});
                return false;
            }
