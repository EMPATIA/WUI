<header>
    <nav class="navbar navbar-top-login">
        <div class="container">
            @include('public.empavilleSchools._layouts.languages')
                ...
                <!-- User Account Menu -->
                    <li class="dropdown">
                        ...
                        <ul id="dropdownLoginID" class="dropdown-menu dropdownLogin">
                            <li class="dropdownLoginUserInfo">
                                    ...
                                    <li class="">
                                        <div class="">
                                            ...
                                            <div class="profile-username-container">
                                                <h3 class="">{{ Session::get('user')->name }}</h3>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
    ...
    <nav class="navbar navbar-top-menus">
        ...
        <div class="container">
            <div class="home-logo">
                <a href='{{url('/')}}'><img class="logo" id='logo' alt="Logo" src="{{asset('images/empavilleSchools/empavilleSchools_logoColor.png')}}" height="45px" /></a>
            </div>
            ...
            <div class="collapse navbar-collapse navigationTopBar" id="navBarMenu">
