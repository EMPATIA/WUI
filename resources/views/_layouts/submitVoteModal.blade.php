...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="card-header">
            ...
            <h4 class="modal-title">{!! $title or trans("form.modal_submit_vote_title") !!}</h4>
        </div>
        <div class="modal-body">
            <p>{!! $msg or "form.modal_submit_vote_msg" !!}</p>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-flat btn-preview"
                    id="confirm">{!! $btn_ok or "form.modal_submit_vote_aprove" !!}</button>
            <button type="button" class="btn empatia"
                    data-dismiss="modal">{!! $btn_ko or "form.modal_submit_vote_cancel" !!}</button>
        </div>
    </div>
</div>
